...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		if(($submit=='simpan') AND isset($_REQUEST['nis'])){
			$nis = $_REQUEST['nis'];
			$sql = mysqli_query($connect,"INSERT INTO kelas VALUES('$kelas','$tapel','$nis','$idrombel')");
		}
		...
		$qkelas = mysqli_query($connect,"SELECT nis FROM kelas WHERE kelas='$kelas' AND th_pelajaran='$tapel' AND idrombel='$idrombel'");
