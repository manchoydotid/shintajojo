...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($connect,"INSERT INTO jenis_bayar VALUES('$tapel','$tingkat','$jenis','$jumlah')");
	...
	<div class="form-group">
		...
		<div class="col-sm-2">
			<select name="jenis" id="jenis" class="form-control">
				...
				<option value="Kg">Kegiatan</option>
				<option value="Kr">Kurban</option>
				<option value="Zk">Zakat</option>
				<option value="Ot">Outing</option>
				<option value="Ms">Manasik</option>
			</select>
		</div>
	</div>
	<div class="form-group">
